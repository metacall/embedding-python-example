#
#	MetaCall Embedding Python Example by Parra Studios
#	An example of embedding Python into C/C++.
#
...
RUN git clone https://github.com/metacall/embedding-python-example.git \
